...
export default function Page() {
    ...
    return (
        <section className="w-screen overflow-x-hidden bg-gray-400 max-md:h-auto max-md:flex-col max-md:p-0 h-[750vh] flex items-center justify-center relative">
            ...
            <p className=" text-[8vw] mix-blend-difference text-white fixed top-1/2 left-1/2 -translate-x-1/2 w-full text-center leading-[.5] -translate-y-1/2 max-md:text-white z-1">
                MOVE CURSOR <br />
                <span className="text-[2vw]">ON IMAGES TO SEE THE EFFECT</span>
            </p>
            ...
            <div className="relative w-full flex flex-col  gap-[10vh] items-center">
                ...
                <div className="curved-scroll-box size-[30vw] max-md:size-[70vw] overflow-hidden ml-[25vw] max-md:mx-auto max-md:mx-auto rounded-[2vw] transform-gpu backface-hidden">
