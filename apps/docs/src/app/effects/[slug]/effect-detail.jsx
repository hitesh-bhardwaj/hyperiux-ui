        ...
        <div className="max-w-6xl mx-auto px-8 pt-12 pb-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              {/* Title Section */}
              <div>
                <h1 className="text-3xl text-neutral-900 dark:text-white mb-2">
                  {effect.title}
                </h1>
    ...
    <div className="flex items-center justify-center h-full">
      <div className="text-8xl opacity-10 dark:opacity-20 text-neutral-900 dark:text-neutral-100">
        ...
        {effect.category === "cursor" && "◈"}
            ...
            <div className="lg:sticky lg:top-30 lg:self-start space-y-6">
              {/* Action buttons */}
              <div className="flex items-center gap-3">
                <Link
                  href={effect.previewUrl || `/effects/${slug}/preview`}
                  target="_blank"
                  className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-neutral-200 bg-white text-neutral-600 hover:bg-primary hover:text-white rounded-lg hover:border-transparent dark:bg-neutral-800 dark:text-white dark:border-neutral-700 transition-colors"
                >
