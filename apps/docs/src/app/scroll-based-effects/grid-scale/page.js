      ...
      <section id='grid-scale' className='h-[400vh] w-full bg-[#242424]'>
        <div className='h-screen w-full sticky top-0 overflow-hidden'>
          ...
          >
            ...
            <p ref={ideaTextRef} className='text-[#242424] max-md:w-[20vw] absolute top-[35%] left-[48%] -translate-x-1/2 -translate-y-1/2 leading-[1.1] max-md:text-[5vw] text-[2.2vw]'>Need immersive UI?<br /> Hyperiux makes it <br /> move.</p>
          </div>
          ...
          {floatingWords.map((word, i) => (
            <div
              key={i}
              className={`floating-word-${i} z-300 absolute px-4 py-1 font-bold text-sm max-md:text-[2vw] uppercase tracking-wider ${word.color}`}
            >
