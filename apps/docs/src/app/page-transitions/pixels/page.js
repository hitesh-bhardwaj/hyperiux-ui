    ...
    return (
        <section className='h-screen w-full bg-zinc-200 flex items-center justify-center'>
            <div>
                ...
                <Link href='/page-transitions/pixels/page2' className='text-sm uppercase rounded-full px-6 py-3 bg-white w-fit block mx-auto hover:bg-primary hover:text-white duration-300'>
                    Go to Page 2
                </Link>
            </div>
        </section>
