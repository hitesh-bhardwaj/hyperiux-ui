...
export default function page() {
 ...
 <Link href='/page-transitions/block/page2' className='text-sm uppercase rounded-full px-6 py-3 bg-white w-fit block mx-auto hover:bg-primary hover:text-white duration-300 text-black'>
 Go to Page 2
 </Link>
 </div>
 </section>
