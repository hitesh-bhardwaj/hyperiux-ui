...
export default function FiddelAsciiCursor({  src,  type ='video',  className ='h-[30vw] w-auto aspect-video',
 gridSize = GRID_SIZE,
 ...
 cellImageMapRef.current.set(key, {  gridIndex: index,  timestamp,  randomDelay: Math.random() * 500  })
 }
 }
