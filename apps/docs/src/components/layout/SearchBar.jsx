...
export function GlobalSearch({ effects = [] }) {
 ...
 <div className="bg-white/70 rounded-lg shadow-2xl overflow-hidden border border-neutral-200">
 {/* Search input */}
 ...
 placeholder="Search effects..."
 className="flex-1 p-2 bg-transparent text-neutral-900 placeholder:text-neutral-400 focus:outline-none"
 />
