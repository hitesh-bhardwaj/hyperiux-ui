...
export function Sidebar({ effectCounts = {}, totalEffects = 0 }) {
  ...
  return (
    <aside className="fixed left-0 top-0 bottom-0 w-65 z-40 p-3 bg-background">
      <div className="flex flex-col h-full w-full bg-white/50 dark:bg-neutral-900/50 border rounded-lg border-neutral-200 dark:border-neutral-800">
        ...
        <nav className="flex-1 overflow-y-auto p-4">
          ...
          <div className="mb-6">
            <Link
              href="/effects"
              className={`flex items-center gap-3 px-3 py-2.5 rounded-lg mb-2 transition-colors ${pathname === "/effects" && currentCategory === "all"
